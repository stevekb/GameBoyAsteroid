...
OFILES = main.o mylib.o title.o pausescreen.o playershipsprite.o gamefinish.o winscreen.o livesimage.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = mylib.h title.h pausescreen.h playershipsprite.h gamefinish.h winscreen.h livesimage.h
